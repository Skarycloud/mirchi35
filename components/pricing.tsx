    ...
    return (
        <section id="pricing" className="py-16 md:py-32">
            <div className="mx-auto max-w-6xl px-6">
                {/* Section Header */}
                <FadeIn direction="down" className="mx-auto max-w-2xl space-y-4 text-center">
                ...
                <div className="mt-12 grid gap-6 md:mt-16 md:grid-cols-3">
                    {plans.map((plan, index) => (
                        ...
                        >
                            <Card
                                className={`relative flex flex-col w-full h-full ${plan.popular ? 'border-orange-500 shadow-lg shadow-orange-500/10' : ''}`}>
                                {plan.popular && (
