            ...
            <div className="mx-auto max-w-5xl px-6">
                ...
                <div className="relative">
                    <div className="relative z-10 grid grid-cols-6 gap-3">
                        ...
                        >
                            <Card className="w-full flex overflow-hidden">
                                <CardContent className="relative m-auto size-fit pt-6">
                                    ...
                                    <h2 className="mt-6 text-center text-3xl font-semibold transform group-hover:scale-105 transition-transform duration-300">Built for your neighborhood</h2>
                                </CardContent>
                            </Card>
                        </FadeIn>
                                    ...
                                    <div className="relative mx-auto flex h-32 w-full items-center justify-center">
                                        <svg
                                            ...
                                            <g transform="translate(145, 50)">
                                                {/* Pulse ring animation - CSS optimized */}
                                                <circle cx="0" cy="0" r="8" className="fill-zinc-400/20 dark:fill-zinc-500/20 animate-ping origin-center" style={{ animationDuration: '2.5s' }} />
                                                
                                                {/* Solid dot */}
                                                <circle cx="0" cy="0" r="5" className="fill-zinc-500 dark:fill-zinc-400 animate-pulse" />
                        ...
                        {/* Card 4 - Relevance over noise */}
                        <FadeIn 
                            delay={0.5} 
                            className="relative col-span-full lg:col-span-3"
                            whileHover={{ y: -5 }}
                        >
                            <Card className="card variant-outlined w-full overflow-hidden h-full">
